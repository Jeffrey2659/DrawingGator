#ifndef STD_CLASS_REWRITES
#define STD_CLASS_REWRITES
...
public:
  ...
  ArrayList& insert(T newValue, int index) {
  ...
  ArrayList& append(T newValue) {
    insert(newValue, size);
    return *this;
  }
  ArrayList& appendRef(T& newValue) {
    insert(newValue, size);
    return *this;
  }
